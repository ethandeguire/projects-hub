  ...
  (function () {
    function aa(g) {
      ...
      !g || g.readyState && !/loaded|complete/.test(g.readyState) || (g.onerror = g.onload = g.onreadystatechange = null, --S, S || k.setTimeout(T, 0), g.parentNode && g.parentNode.removeChild(g),
        g = null)
      }; g.type = "text/javascript"; g.src = "" + encodeURIComponent(H[l]) + ".js"; N.insertBefore(g, N.firstChild);
    })(H[l]); for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l)F.push("" + encodeURIComponent(P[l]) + ".css"); F.push(window.location.origin + "/libraries/code-prettify/prettify.css"); (function (g) {
      function r(l) {
        if (l !== x) {
